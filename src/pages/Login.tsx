...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#111] overflow-hidden">
        {/* Ring Auth Container */}
        <div className="ring mx-auto max-w-md">
          <i></i>
          <i></i>
          <i></i>
          <div className="login-ring">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6 bg-transparent border border-white/20 rounded-lg p-1">
                <TabsTrigger 
                  value="signin"
                  className="data-[state=active]:bg-white/20 data-[state=active]:text-white text-white/70 rounded-md py-2"
                >
                  Sign In
                </TabsTrigger>
                <TabsTrigger 
              ...
              <TabsContent value="signin" className="w-full">
                <form onSubmit={handleSignIn} className="space-y-4 w-full">
                  <div className="inputBx space-y-2">
                    <Label htmlFor="signin-email" className="text-white sr-only">
                      Email
                    </Label>
                    <Input
                      id="signin-email"
                      ...
                      required
                      className="bg-transparent border-2 border-white rounded-[40px] text-white placeholder:text-white/75 text-base px-5 py-3 focus:outline-none focus:border-[hsl(164,65%,50%)] ring-0"
                    />
                  </div>

                  <div className="inputBx space-y-2">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="signin-password" className="text-white sr-only">
                        Password
                      </Label>
                      <a href="#" className="text-xs text-[hsl(164,65%,50%)] hover:text-white/70 transition-colors links-item">
                        Forgot password?
                      </a>
                    </div>
                    <Input
                  ...
                  <div className="inputBx">
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-[hsl(164,65%,50%)] to-white text-black font-semibold rounded-[40px] py-3 px-6 hover:from-[hsl(153,60%,40%)] ring-0 border-0"
                    >
                  ...
                  <div className="inputBx">
                    <Button
                      ...
                      disabled={isSubmitting}
                      variant="outline"
                      className="w-full bg-white hover:bg-gray-100 text-gray-900 border-0 font-semibold rounded-[40px] py-3 px-6"
                    >
                  ...
                  {/* Trust Indicators */}
                  <div className="mt-6 pt-4 border-t border-white/10 space-y-2 w-full">
                ...
                <form onSubmit={handleSignUp} className="space-y-4 w-full">
                  ...
                  <div className="inputBx">
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-[hsl(164,65%,50%)] to-white text-black font-semibold rounded-[40px] py-3 px-6 hover:from-[hsl(153,60%,40%)] ring-0 border-0 disabled:opacity-50"
                    >
